...
let scaleBlock (compList:ComponentId list) (model:SymbolT.Model) (Mag:float)=
    ...
    let newSymbols = List.map (SmartHelpers.scaleSymbolInBlock Mag block) SelectedSymbols
