...
var grammar = {
    ...
    {"name": "MODULE$ebnf$1$subexpression$1", "symbols": ["_", (lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_PORT_LIST", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d){return d[4];}},
    ...
    {"name": "PARAMETER_ASSIGNMENT", "symbols": ["IDENTIFIER", "_", (lexer.has("op_assign") ? {type: "op_assign"} : op_assign), "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "parameter", Identifier: d[1], RHS: d[5], Location: d[0] ? d[0].Location : d[1].Location};}},
    ...
    {"name": "PARAMETER_ITEM$ebnf$1$subexpression$1", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit), "__"]},
    {"name": "PARAMETER_ITEM$ebnf$1", "symbols": ["PARAMETER_ITEM$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "PARAMETER_ITEM$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "PARAMETER_ITEM", "symbols": [(lexer.has("parameter") ? {type: "parameter"} : parameter), "__", "PARAMETER_ITEM$ebnf$1", "_", "PARAMETER_LIST"], "postprocess": function(d) {return {Type: "item", ItemType: "parameter_decl", ParamDecl: {Type: "parameter_item", DeclarationType: "parameter", Parameters: d[2]}, Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_LIST", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "PARAMETER_PORT_ITEM", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: d[3].concat([d[7].ParamDecl.Parameters]), Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_PORT_ITEM", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "PARAMETER_PORT_ITEM", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: [d[3].ParamDecl.Parameters, d[7].ParamDecl.Parameters], Location: d[0].offset};}},
    ...
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_PORT_ITEM", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: [d[3].ParamDecl.Parameters], Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_ITEM", "symbols": ["PARAMETER_ITEM"], "postprocess": function(d) {return d[0];}},
    {"name": "PARAMETER_PORT_ITEM", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit), "__", "PARAMETER_LIST"], "postprocess": function(d) {return {Type: "item", ItemType: "parameter_decl", ParamDecl: {Type: "parameter_item", DeclarationType: "parameter", Parameters: d[2]}, Location: d[0].offset};}},
    ...
    {"name": "MODULE_ITEM", "symbols": ["PARAMETER_ITEM", "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"], "postprocess": id},
    ...
    {"name": "NON_PORT_MODULE_ITEM", "symbols": ["PARAMETER_ITEM"], "postprocess": id},
    ...
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_bit2", BitsStart: d[4], BitsEnd: d[4], Primary: d[0]};}},
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_bits", BitsStart: d[4], BitsEnd: d[8], Primary: d[0]};}},
