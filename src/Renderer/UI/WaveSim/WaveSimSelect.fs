...
let getInputPortName (compType: ComponentType) (port: InputPortNumber) : string =
    ...
    | Not | BusCompare _ | BusCompare1 _ ->
        ".IN"
    | And | Or | Xor | Nand | Nor | Xnor | AndN _ | NbitsNot _ | NbitSpreader _ ->
        ".IN" + string port
...
let getInputName (withComp: bool) (comp: FastComponent) (port: InputPortNumber) : string =
    ...
    let bitLims : string =
        ...
        | Not | BusCompare _ | BusCompare1 _ | And | Or | Xor | Nand | Nor | Xnor | AndN _
...
let getOutputPortName (compType: ComponentType) (port: OutputPortNumber) : string =
    match compType with
    | Not | And | Or | Xor | Nand | Nor | Xnor | AndN _ | Decode4 | Mux2 | Mux4 | Mux8 | BusCompare _ | BusCompare1 _ | NbitsXor _ | NbitsNot _  | NbitSpreader _ | NbitsAnd _ | NbitsOr _ |Shift _->
        ".OUT"
...
let getOutputName (withComp: bool) (comp: FastComponent) (port: OutputPortNumber) (fastSim: FastSimulation): string =
    ...
    let bitLims =
        match comp.FType with
        | Not | And | Or | Xor | Nand | Nor | Xnor | AndN _ | BusCompare _ | BusCompare1 _
