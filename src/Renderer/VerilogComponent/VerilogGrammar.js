...
var grammar = {
    ...
    {"name": "PARAMETER_ASSIGNMENT", "symbols": ["IDENTIFIER", "_", (lexer.has("op_assign") ? {type: "op_assign"} : op_assign), "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "parameter", Identifier: d[0], RHS: d[4], Location: d[0].Location};}},
    {"name": "PARAMETER_LIST", "symbols": ["PARAMETER_ASSIGNMENT", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "PARAMETER_LIST"], "postprocess": function(d) {return [d[0]].concat(d[4]);}},
    {"name": "PARAMETER_LIST", "symbols": ["PARAMETER_ASSIGNMENT"], "postprocess": function(d) {return [d[0]];}},
    {"name": "PARAMETER_DECL$ebnf$1$subexpression$1", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit), "__"]},
    {"name": "PARAMETER_DECL$ebnf$1", "symbols": ["PARAMETER_DECL$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "PARAMETER_DECL$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "PARAMETER_DECL", "symbols": ["parameter", "__", "PARAMETER_DECL$ebnf$1", "_", "PARAMETER_LIST"], "postprocess": function(d) {return {Type: "item", ItemType: "parameter_decl", ParamDecl: {Type: "parameter_item", DeclarationType: "parameter", Parameters: d[4]}, Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_LIST", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "PARAMETER_PORT_DECL", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: d[3].concat(d[7].ParamDecl.Parameters), Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_LIST", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: d[3], Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_PORT_DECL", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "PARAMETER_PORT_DECL", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: (d[3].ParamDecl.Parameters).concat(d[7].ParamDecl.Parameters), Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_LIST", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "PARAMETER_PORT_DECL", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "parameter_port_list", Parameters: d[3].ParamDecl.Parameters, Location: d[0].offset};}},
    {"name": "PARAMETER_PORT_DECL", "symbols": ["PARAMETER_DECL"], "postprocess": function(d) {return d[0];}},
    {"name": "PARAMETER_PORT_DECL", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit), "__", "PARAMETER_LIST"], "postprocess": function(d) {return {Type: "item", ItemType: "parameter_decl", ParamDecl: {Type: "parameter_item", DeclarationType: "parameter", Parameters: d[2]}, Location: d[0].offset};}},
    ...
    {"name": "MODULE_ITEM", "symbols": ["PARAMETER_DECL", "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon), "_"], "postprocess": id},
    ...
    {"name": "NON_PORT_MODULE_ITEM", "symbols": ["PARAMETER_DECL"], "postprocess": id},
    ...
    {"name": "RANGE", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d,l,reject) {return {Type: "range", Start: d[2], End: d[6], Location: d[0].offset};}},
    {"name": "ARRAY_RANGE", "symbols": ["RANGE", "_", "ARRAY_RANGE"], "postprocess": function(d,l,reject) {return [d[0]].concat(d[2]);}},
    {"name": "ARRAY_RANGE", "symbols": ["RANGE"], "postprocess": function(d,l,reject) {return [d[0]];}},
    {"name": "DATATYPE", "symbols": [(lexer.has("bit") ? {type: "bit"} : bit)], "postprocess": function(d) {return {type: "bit", offset: d[0].offset};}},
    {"name": "DATATYPE", "symbols": [(lexer.has("wire") ? {type: "wire"} : wire)], "postprocess": function(d) {return {type: "wire", offset: d[0].offset};}},
    ...
    {"name": "STATEMENT2", "symbols": ["SEQ_BLOCK"], "postprocess": function(d,l,reject) {return {Type: "statement", StatementType: "seq_block", NonBlockingAssign: null, BlockingAssign: null, SeqBlock: d[0], Conditional: null,  CaseStatement: null, ForStatement: null, Location: d[0].Location};}},
    {"name": "STATEMENT2", "symbols": ["CONDITIONAL_STATEMENT"], "postprocess": function(d,l,reject) {return {Type: "statement", StatementType: "conditional", NonBlockingAssign: null, BlockingAssign: null, SeqBlock: null, Conditional: d[0],  CaseStatement: null, ForStatement: null, Location: d[0].Location};}},
    ...
    {"name": "MODULE_INSTANTIATION_STATEMENT$ebnf$1$subexpression$1", "symbols": [(lexer.has("hash") ? {type: "hash"} : hash), "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "LIST_OF_OVERRIDEN_PARAMS", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "__"], "postprocess": function(d){return d[4];}},
    {"name": "MODULE_INSTANTIATION_STATEMENT$ebnf$1", "symbols": ["MODULE_INSTANTIATION_STATEMENT$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "MODULE_INSTANTIATION_STATEMENT$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "MODULE_INSTANTIATION_STATEMENT", "symbols": ["IDENTIFIER", "__", "MODULE_INSTANTIATION_STATEMENT$ebnf$1", "IDENTIFIER", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "LIST_OF_PORT_CONNECTIONS", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen), "_", (lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess": (d) => {return {Type: "module_instantiation", Module: d[0], Identifier: d[3], Parameters: d[2], Connections: d[7]}}},
    {"name": "LIST_OF_OVERRIDEN_PARAMS", "symbols": ["OVERRIDEN_PARAM", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "LIST_OF_OVERRIDEN_PARAMS"], "postprocess": function(d) {return [d[0]].concat(d[4]);}},
    {"name": "LIST_OF_OVERRIDEN_PARAMS", "symbols": ["OVERRIDEN_PARAM"], "postprocess": function(d) {return [d[0]];}},
    {"name": "OVERRIDEN_PARAM", "symbols": [(lexer.has("dot") ? {type: "dot"} : dot), "_", "IDENTIFIER", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "EXPRESSION", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "overriden_param", Identifier: d[2], Value: d[6]};}},
    ...
    {"name": "ARRAY_L_VALUE", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "UNSIGNED_NUMBER", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket), "_", "ARRAY_L_VALUE"], "postprocess": function(d) {return [{BitsStart: d[1], BitsEnd: d[1]}].concat(d[4]); }},
    {"name": "ARRAY_L_VALUE", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "UNSIGNED_NUMBER", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return [{BitsStart: d[1], BitsEnd: d[1]}]; }},
    ...
    {"name": "L_VALUE", "symbols": ["IDENTIFIER", "_", "ARRAY_L_VALUE", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "UNSIGNED_NUMBER", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "l_value", PrimaryType: "identifier_array", Primary: d[0], ArrayIndices: d[2], BitsStart: d[5], BitsEnd: d[5]};}},
    {"name": "L_VALUE", "symbols": ["IDENTIFIER", "_", "ARRAY_L_VALUE", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "UNSIGNED_NUMBER", (lexer.has("colon") ? {type: "colon"} : colon), "UNSIGNED_NUMBER", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "l_value", PrimaryType: "identifier_array", Primary: d[0], ArrayIndices: d[2], BitsStart: d[5], BitsEnd: d[7]};}},
    ...
    {"name": "UNARY", "symbols": ["UNSIGNED_NUMBER2"], "postprocess": function(d) {return {Type: "number", Primary: null, Number: d[0], Expression: null};}},
    {"name": "UNARY", "symbols": [(lexer.has("unsigned_number") ? {type: "unsigned_number"} : unsigned_number), (lexer.has("decimalBase") ? {type: "decimalBase"} : decimalBase), (lexer.has("lparen") ? {type: "lparen"} : lparen), "PRIMARY", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": function(d) {return {Type: "param_number", Primary: null, Number: null, Expression: null, ParamNumber: {Type: "param_number", Primary: d[3], Bits: d[0].value}};}},
    ...
    {"name": "ARRAY_SELECT", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket), "_", "ARRAY_SELECT"], "postprocess": function(d,l,reject) {return [d[1]].concat(d[5]);}},
    {"name": "ARRAY_SELECT", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d,l,reject) {return [d[1]];}},
    ...
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket), "_", "ARRAY_SELECT"], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_array", BitsStart: d[4], BitsEnd: d[4], Primary: d[0], Expression: d[4], ArraySelect: d[8]};}},
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("minus") ? {type: "minus"} : minus), "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "UNSIGNED_NUMBER", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_bits_select", BitsStart: d[4], BitsEnd: null, Primary: d[0], Expression: d[4], Width:parseInt(d[10].value), SelectType: "minus"};}},
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "EXPRESSION", "_", (lexer.has("plus") ? {type: "plus"} : plus), "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "UNSIGNED_NUMBER", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_bits_select", BitsStart: d[4], BitsEnd: null, Primary: d[0], Expression: d[4], Width:parseInt(d[10].value), SelectType: "plus"};}},
    ...
    {"name": "UNSIGNED_NUMBER2", "symbols": [(lexer.has("unsigned_number") ? {type: "unsigned_number"} : unsigned_number)], "postprocess": function(d,l,reject) {return {Type: "number", NumberType: "unsigned", Bits: null, Base: null, UnsignedNumber: d[0].value, AllNumber: null, Location: d[0].offset};}},
