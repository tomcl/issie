...
let iteratedLocalSearchSingleComponent (initialModel: SheetT.Model) : SheetT.Model =
    ...
    optimisationLoop initialModel initialBestStates 0module SheetBeautify
...
type BestStateRecord = { BestStates: Map<ComponentId, ComponentState>; Model: SheetT.Model }
