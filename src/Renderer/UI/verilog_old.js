...
(function () {
    ...
    var grammar = {
        ...
        {"name": "XOR_XNOR_OPERATOR", "symbols": ["XOR_XNOR_OPERATOR$string$2"], "postprocess": function(d) {return d[0].join('');}},
        ...
        {"name": "SHIFT_OPERATOR", "symbols": ["SHIFT_OPERATOR$string$2"], "postprocess": function(d) {return d[0].join('');}},
