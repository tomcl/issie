...
let viewSimSubTab canvasState model dispatch =
    ...
    | WaveSim ->
        div
            [ Style [ Width "100%"; Height "calc(100% - 72px)"; MarginTop "15px" ] ]
...
let private viewRightTab canvasState model dispatch =
    ...
    | Transition ->
        ...
        div
            [ Style [ Width "90%"; MarginLeft "5%"; MarginTop "15px"; Height "calc(100%-100px)" ] ]
            [ Heading.h4 [] [ str "Catalogue" ]
              div
                  [ Style [ MarginBottom "15px"; Height "100%"; OverflowY OverflowOptions.Auto ] ]
    ...
    | Simulation ->
        ...
        div
            [ HTMLAttr.Id "RightSelection2"; Style [ Height "100%" ] ]
            [
        ...
        div
            ...
            [ Heading.h4 [] [ str "Build" ]
              div
                  ...
                  [ str "Compile your design and upload it to one of the supported devices" ]
...
let inline setDragMode (modeIsOn: bool) (model: Model) dispatch =
    fun (ev: Browser.Types.MouseEvent) ->
        ...
        | true, DragModeOff ->
            dispatch
            <| SetDragMode(DragModeOn(int ev.clientX))
        | false, DragModeOn _ -> dispatch <| SetDragMode DragModeOff
        | _ -> ()
...
let dividerbar (model: Model) dispatch =
    ...
    let heightAttr =
        ...
        if (isNull rightSection) then
            Height "100%"
        else
            Height "100%" //rightSection.scrollHeight
    let variableStyle =
        if isDraggable then
    ...
    let commonStyle = [ heightAttr; Float FloatOptions.Left ]
    div
...
let viewRightTabs canvasState model dispatch =
    ...
    div
        [ HTMLAttr.Id "RightSelection"
          Style [ Height "100%"; OverflowY OverflowOptions.Auto ] ]
        [ Tabs.tabs
              [ Tabs.IsFullWidth
                Tabs.IsBoxed
                Tabs.CustomClass "rightSectionTabs"
                          ...
                          [ OnClick(fun _ ->
                                let target =
                                    if model.RightPaneTabVisible = Simulation then
                                        ...
                                        Catalogue
                                dispatch <| ChangeRightTab target) ]
                          [ str "Catalogue" ] ]
...
let displayView model dispatch =
    ...
    let inline processMouseMove (keyUp: bool) (ev: Browser.Types.MouseEvent) =
        ...
        | DragModeOn pos, 1., false ->
            ...
            dispatch
            <| SetDragMode(DragModeOn(int ev.clientX - w + newWidth))
    ...
    let topCursorText =
        match model.Sheet.CursorType with
        | SheetT.Spinner -> "wait"
        | _ -> ""
    ...
    | Some fn -> dispatch <| UpdateModel fn
    | None -> ()
    div
        ...
        [
          ...
          if model.PopupDialogData.Progress <> None then
              ...
              div
                  [ HTMLAttr.Id "RightSection"; rightSectionStyle model ]
