...
let viewInfoPopup dispatch =
    ...
    let about = div [] [
        ...
        str "ISSIE was created in 2020 by Marco Selvatici (EIE 3rd year) as his BEng final year project. \
             The original waveform viewer was created \
             ...
             in 2025 the HLP class innovated the first parameter system. \
             In 2026 Youjie Wang updated the build system with autogenerated binaries. Beth Cham improved the Verilog compiler."
        br []; br [] 
        makeH "Technology"
        Text.span [] [
