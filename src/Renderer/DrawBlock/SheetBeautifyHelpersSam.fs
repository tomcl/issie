...
/// <param name="edge">Side of a symbol, of type <c>Edge</c>.</param>
/// <param name="sym">Target symbol.</param>
...
// B4R
/// <summary>Get input reverse state of a <c>Mux</c> or <c>Demux</c> symbol.</summary>
/// <param name="sym">Target <c>Mux</c> or <c>Demux</c> symbol.</param>
/// <returns>Boolean of reverse state of <c>Mux</c> or <c>Demux</c> symbol.
/// False is returned when reverse state is not set.
/// False is also returned when given symbol is not a <c>Mux</c> or <c>Demux</c> symbol.</returns>
...
// B4W
/// <summary>Set input reverse state of a <c>Mux</c> or <c>Demux</c> symbol.</summary>
/// <param name="state">Reverse state to set symbol to.</param>
/// <param name="sym">Target <c>Mux</c> or <c>Demux</c> symbol.</param>
/// <returns>New symbol with updated reverse set.
/// Original symbol returned if symbol is not of type <c>Mux</c> or <c>Demux</c>.</returns>
...
/// <param name="port">Port to locate, of type <c>Port</c>.</param>
...
/// <param name="sym">Target symbol.</param>
/// <returns>Rotation state, of type <c>Rotation</c>.</returns>
let getSymRotation (sym: SymbolT.Symbol): Rotation =
    sym.STransform.Rotation

// B7W
/// <summary>Set rotation state of a symbol.</summary>
/// <param name="rotate">Rotation state to set to, of type <c>Rotation</c>.</param>
/// <param name="sym">Target symbol.</param>
...
/// <param name="sym">Target symbol.</param>
/// <returns>Flipped state, of <c>bool</c> type.</returns>
...
/// <param name="sheet">Model of the whole sheet.</param>
/// <returns>List of <c>ComponentId</c>s of all the symbols on the sheet.</returns>
...
/// <param name="wire">Target wire, of type <c>Wire</c>.</param>
/// <returns>List of <c>XYPos</c> that represents the vectors of segments in a wire.</returns>
...
let getWireSegVectors (wire: BusWireT.Wire): List<XYPos> =
    ...
    /// <summary>Helper to convert segment into <c>XYPos</c> vectors.</summary>
...
/// <param name="wire">Target wire, of type <c>Wire</c>.</param>
/// <returns>List of <c>XYPos</c> that represents the vertices in a wire.</returns>
/// <remarks>Function seems to have same functionality as <c>BlockHelpers.getWireSegmentXY</c>.
...
let findVisibleSegLength (sheet: SheetT.Model): float =
    /// <summary>Helper to union the start and end positions of <c>seg2</c> into <c>seg1</c> if possible.</summary>
    ...
    /// <returns>Union-ed segment if successfully union-ed. <c>None</c> if cannot union.</remarks>
