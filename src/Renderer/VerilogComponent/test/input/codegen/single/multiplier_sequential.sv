//source: https://github.com/snbk001/Verilog-Design-Examples/blob/main/Sequential%20Multiplier/seqmult.v
module seqmult(
               in_a                                                     ,//input
               in_b                                                     ,//input
               clk                                                      ,//clock
...
//port declaration
input bit      [ 7:0]   in_a                                               ;//8 bit multiplicand declaration
input bit      [ 7:0]   in_b                                               ;//8 bitmultiplier declaration
input bit               clk                                                ;//clock declaration
input bit               load                                               ;//load declaration
input bit               reset                                              ;//reset declaration
output bit           out_valid                                          ;//output valid signal declaration
output bit  [15:0]   out_prod                                           ;//16 bit output product declaration
bit         [15:0]   p1, p2, p3, p4, p5, p6, p7, p8                     ;//partial products(pp)
bit        [15:0]   temp_prod                                          ;//temparory product for shift operation
