...
(function () {
    ...
    var grammar = {
        ...
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"|"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION$string$1", "symbols": [{"literal":"~"}, {"literal":"^"}], "postprocess": function joiner(d) {return d.join('');}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", "EXPRESSION$string$1", "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"^"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"&"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"^"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"+"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["EXPRESSION", "_", {"literal":"-"}, "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "bin_expression", Operator: d[2], Expression: null, ExpressionLeft: d[0], ExpressionRight: d[4], Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["UNARY_OPERATOR", "_", "EXPRESSION"], "postprocess": function(d) {return {Type: "unary_expression", Operator: d[0][0], Expression: d[2], ExpressionLeft: null, ExpressionRight: null, Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": [{"literal":"("}, "_", "EXPRESSION", "_", {"literal":")"}], "postprocess": function(d) {return {Type: "bin_expression", Operator: "parenthesis", Expression: d[2], ExpressionLeft: null, ExpressionRight: null, Primary: null, Number: null};}},
        {"name": "EXPRESSION", "symbols": ["PRIMARY"], "postprocess": function(d) {return {Type: "primary", Expression: null, ExpressionLeft: null, ExpressionRight: null, Primary: d[0], Number: null};}},
        {"name": "EXPRESSION", "symbols": ["NUMBER"], "postprocess": function(d) {return {Type: "number", Expression: null, ExpressionLeft: null, ExpressionRight: null, Primary: null, Number: d[0]};}},
        ...
        {"name": "UNARY_OPERATOR", "symbols": ["UNARY_OPERATOR$string$3"]},
