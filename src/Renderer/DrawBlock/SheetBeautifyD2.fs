...
/// <param name="orientAndPortInfo">Tuple of flipped status, rotation, and <c>PortMaps.Order</param>
...
/// <summary>[DO NOT USE - WIP] </summary>
...
/// rotation, and <c>PortMaps.Order</param>
...
/// <summary>Set a mux's or demux's reversedInputPort state in a sheet.</summary>
...
/// <summary>Set a symbol's reversedInputPort state in a sheet.</summary>
/// <param name="sym">Target symbol.</param>
/// <param name="sheet">Model of the whole sheet.</param>
/// <returns>Updated sheet.</returns>
let setSymPortOrder
...
/// <remarks>Symbols were ordered so as: 
