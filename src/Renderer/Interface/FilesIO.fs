...
/// Ask the user to choose a set of sheets they want to import, with a dialog window.
/// Return a list of paths to these sheets.
/// Return None if the user exits withouth selecting a sheet.
