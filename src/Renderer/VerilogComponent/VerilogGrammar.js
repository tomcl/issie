...
var grammar = {
    ...
    {"name": "PARAMETER_DECL", "symbols": [(lexer.has("parameter") ? {type: "parameter"} : parameter), "__", "PARAMETER_DECL$ebnf$1", "_", "PARAMETER_LIST"], "postprocess": function(d) {return {Type: "item", ItemType: "parameter_decl", ParamDecl: {Type: "parameter_item", DeclarationType: "parameter", Parameters: d[4]}, Location: d[0].offset};}},
    ...
    {"name": "ARRAY_RANGE", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "RANGE", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket), "_", "ARRAY_RANGE"], "postprocess": function(d,l,reject) {return [d[2]].concat(d[6]);}},
    {"name": "ARRAY_RANGE", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "RANGE", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d,l,reject) {return [d[2]];}},
