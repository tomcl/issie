...
let couldBeSynchronousComponent compType : bool =
    ...
    | Nand | Nor | Xnor | Mux2 | Mux4 | Mux8 | Demux2 | Demux4 | Demux8 | NbitsAdder _ | NbitsXor _ | NbitsNot _ | NbitSpreader _ |  NbitsAnd _ | Decode4 | AsyncROM1 _ | Viewer _ -> false
...
let rec hasSynchronousComponents graph : bool =
    ...
    |> Map.map (fun compId comp ->
            ...
            | Xor | Nand | Nor | Xnor | Mux2 | Mux4 | Mux8 | Demux2 | Demux4 | Demux8 | NbitsAdder _ | NbitSpreader _ | NbitsXor _ | NbitsNot _ | NbitsAnd _ | Decode4 | AsyncROM1 _ | Constant1 _ | Viewer _ -> false
