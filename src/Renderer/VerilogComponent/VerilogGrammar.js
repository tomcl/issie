...
var grammar = {
    ...
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", "ARRAY_SELECT", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "UNSIGNED_NUMBER", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_array", BitsStart: d[6], BitsEnd: d[6], Primary: d[0], ArrayIndices: d[2]};}},
    {"name": "PRIMARY", "symbols": ["IDENTIFIER", "_", "ARRAY_SELECT", "_", (lexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "UNSIGNED_NUMBER", "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "UNSIGNED_NUMBER", "_", (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": function(d) {return {Type: "primary", PrimaryType: "identifier_array", BitsStart: d[6], BitsEnd: d[10], Primary: d[0], ArrayIndices: d[2]};}},
