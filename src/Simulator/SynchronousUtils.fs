...
let couldBeSynchronousComponent compType : bool =
    ...
    | Input _ | Output _ | IOLabel | MergeWires | SplitWire _ | Not | And | Or | Xor
    | Nand | Nor | Xnor | Mux2 | Demux2 | NbitsAdder _ | AsyncROM _ -> false
...
let rec hasSynchronousComponents graph : bool =
    ...
    |> Map.map (fun compId comp ->
            ...
            | Input _ | Output _ | IOLabel | MergeWires | SplitWire _ | Not | And | Or
            | Xor | Nand | Nor | Xnor | Mux2 | Demux2 | NbitsAdder _ | AsyncROM _ -> false
        )
