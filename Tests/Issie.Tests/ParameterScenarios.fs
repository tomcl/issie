...
let tests =
    testList "ParameterScenarios" [
        ...
        test "two instances with different bindings resolve independently" {
            ...
            let cc8 = childInstance "cc8" 8 (Some(Map [ ParamName "W", PInt 8I ]))
            let cc16 = childInstance "cc16" 16 (Some(Map [ ParamName "W", PInt 16I ]))
        ...
        test "two instances with the same bindings both resolve correctly" {
            ...
            let cca = childInstance "cca" 8 (Some(Map [ ParamName "W", PInt 8I ]))
            let ccb = childInstance "ccb" 8 (Some(Map [ ParamName "W", PInt 8I ]))
