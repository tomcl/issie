...
let makeBoomerang curveOneRange curveTwoRange =
    $"M 0.0 0.0 C 0.0 0.0 {curveOneRange} {(curveOneRange/2.)} 0.0 {curveOneRange} 
    C {curveTwoRange} {curveOneRange} {curveTwoRange}  0.0 0.0 0.0"
