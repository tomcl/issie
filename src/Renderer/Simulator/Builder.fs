...
let private getDefaultState compType =
    ...
    | Input1 _ | Output _ | IOLabel | BusSelection _ | BusCompare _ | BusCompare1 _ 
    | Not | And _ | Or _| Xor _| Nand _| Nor _| Xnor _| Mux2 | Mux4 | Mux8 | Decode4 | NbitSpreader _
    | Demux2 | Demux4 | Demux8 | NbitsAdder _ | NbitsOr _ |NbitsXor _ |NbitsAnd _ |NbitsNot _ 
    | Custom _ | MergeWires | SplitWire _ | ROM1 _  | Viewer _ 
