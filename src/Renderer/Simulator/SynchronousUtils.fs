...
let couldBeSynchronousComponent compType : bool =
    ...
    | Nand | Nor | Xnor | Mux2 | Demux2 | NbitsAdder _ | NbitsXor _ | Decode4 | AsyncROM1 _ -> false
...
let rec hasSynchronousComponents graph : bool =
    ...
    |> Map.map (fun compId comp ->
            ...
            | Xor | Nand | Nor | Xnor | Mux2 | Demux2 | NbitsAdder _ | NbitsXor _ | Decode4 | AsyncROM1 _ | Constant _ -> false
