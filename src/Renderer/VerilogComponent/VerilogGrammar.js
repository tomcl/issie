...
var grammar = {
    ...
    {"name": "MODULE_ITEM$string$1", "symbols": [{"literal":"w"}, {"literal":"i"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$1", "__", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "WIRE-DECL", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
    {"name": "MODULE_ITEM$string$2", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$2", "__", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "NO-COMB", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
    {"name": "MODULE_ITEM$string$3", "symbols": [{"literal":"a"}, {"literal":"l"}, {"literal":"w"}, {"literal":"a"}, {"literal":"y"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$3", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "NO-COMB", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
    {"name": "MODULE_ITEM$string$4", "symbols": [{"literal":"a"}, {"literal":"l"}, {"literal":"w"}, {"literal":"a"}, {"literal":"y"}, {"literal":"s"}, {"literal":"_"}, {"literal":"c"}, {"literal":"o"}, {"literal":"m"}, {"literal":"b"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$4", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "NO-COMB", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
    {"name": "MODULE_ITEM$string$5", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"i"}, {"literal":"t"}, {"literal":"i"}, {"literal":"a"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$5", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "NO-COMB", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
    {"name": "MODULE_ITEM$string$6", "symbols": [{"literal":"c"}, {"literal":"a"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "MODULE_ITEM", "symbols": ["MODULE_ITEM$string$6", "EVERYTHING"], "postprocess": function(d,l, reject) {return {Type: "NO-CASE", ItemType: d[0], IODecl: null, ParamDecl: null, Statement: null, Location: l};}},
